...
export function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <div
      className={cn("bg-teal-800 text-white flex flex-col transition-all duration-300", isCollapsed ? "w-17" : "w-64")}
    >
      {/* Header */}
      ...
      {!isCollapsed && (
        <div className="p-4 border-t border-teal-700">
          <div className="bg-teal-700 rounded-lg p-2 text-center">
            ...
            <Button size="sm" className="w-full bg-lime-400 text-teal-800 hover:bg-lime-500">
              Upgrade Now
            </Button>
          </div>
        </div>
