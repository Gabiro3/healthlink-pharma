...
import { Package, AlertTriangle, Download, Search, Clock, Truck, XCircle, Plus } from "lucide-react"
...
export function EnhancedInventoryManagement({
  ...
  pharmacyId,
  userId,
}: EnhancedInventoryManagementProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <AddProductDialog pharmacyId={pharmacyId} userId={userId} onProductAdded={handleProductAdded} />
        </div>
      </div>
